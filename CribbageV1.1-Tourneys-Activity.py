...
"font: 700 11pt \"Segoe UI\";")
        ...
        self.tourneyActivityFrame = QtWidgets.QFrame(parent=self.sessionFrame)
        self.tourneyActivityFrame.setGeometry(QtCore.QRect(390, 20, 691, 241))
        self.tourneyActivityFrame.setFrameShape(QtWidgets.QFrame.Shape.Panel)
        self.tourneyActivityFrame.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.tourneyActivityFrame.setLineWidth(2)
        self.tourneyActivityFrame.setObjectName("tourneyActivityFrame")
        self.layoutWidget2 = QtWidgets.QWidget(parent=self.tourneyActivityFrame)
