...
"font: 700 11pt \"Segoe UI\";")
        ...
        self.resultsActivityFrame = QtWidgets.QFrame(parent=self.sessionFrame)
        self.resultsActivityFrame.setGeometry(QtCore.QRect(390, 20, 691, 241))
        self.resultsActivityFrame.setFrameShape(QtWidgets.QFrame.Shape.Panel)
        self.resultsActivityFrame.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.resultsActivityFrame.setLineWidth(2)
        self.resultsActivityFrame.setObjectName("resultsActivityFrame")
        self.frame = QtWidgets.QFrame(parent=self.resultsActivityFrame)
        self.frame.setGeometry(QtCore.QRect(30, 20, 641, 201))
        self.frame.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.frame.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.frame.setObjectName("frame")
        self.widget = QtWidgets.QWidget(parent=self.frame)
        self.widget.setGeometry(QtCore.QRect(16, 11, 611, 181))
        ...
        self.resultsActivityFrameLabel = QtWidgets.QLabel(parent=self.sessionFrame)
        self.resultsActivityFrameLabel.setGeometry(QtCore.QRect(402, 8, 63, 20))
